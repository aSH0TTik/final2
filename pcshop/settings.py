...
SECRET_KEY = 'django-insecure-b#v&slf0xro6a+d09*egdci+r82y8u2@ke=60tia&c4zk&^4yg'
...
# После входа отправляем на главную
LOGIN_REDIRECT_URL = '/'

# После выхода отправляем на главную
LOGOUT_REDIRECT_URL = '/'

# Если человек уже вошёл и зашёл на /login/ — отправляем его на главную
LOGIN_URL = '/login/'

CART_SESSION_ID = 'cart'  # имя ключа в сессии для корзины
